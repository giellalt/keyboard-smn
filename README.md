.. -*- mode: rst -*-
==========================================
 Keyboards for the Inari Sami language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Inari Sami language. The data and implementations
...
* http://giellatekno.uit.no/smndoc/index.html
* https://giellalt.uit.no/tools/docu-smn-manual.html
...
The Inari Sami keyboard sources can be acquired using the `Giella SVN
